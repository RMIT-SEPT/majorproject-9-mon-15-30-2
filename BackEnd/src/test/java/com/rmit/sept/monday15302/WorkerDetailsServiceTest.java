...
public class WorkerDetailsServiceTest {
    ...
    @Test
    public void getWorkersByAdminIds_returnWorkers_IfWorkersFound() {
    ...
    @Test(expected = WorkerDetailsException.class)
    public void getWorkersByAdminIds_throwException_IfNoWorkersFound()
            throws WorkerDetailsException {
    ...
    @Test
    public void saveWorker_returnTrue_ifWorkerAdded() {
    ...
    @Test(expected = WorkerDetailsException.class)
    public void saveWorker_throwException_ifWorkerNotAdded()
            throws WorkerDetailsException {
    ...
    @Test
    public void deleteWorker_deleteWorker_ifWorkerFound() {
        Mockito.when(workerDetailsRepository.getByIdAndAdminId(workerId_1, adminId)).thenReturn(worker1);
        // when
    ...
    @Test(expected = WorkerDetailsException.class)
    public void deleteWorker_throwException_ifWorkerNotFound()
            throws WorkerDetailsException {
        workerDetailsService.deleteWorker("Sale", "123");
    }

    @Test
    public void getWorkersByAdminId_returnWorkers_IfWorkersFound() {
        List<EditWorker> workers = workerDetailsService.getWorkersByAdminId(adminId);
        assert(!workers.isEmpty());
    }

    @Test(expected = WorkerDetailsException.class)
    public void getWorkersByAdminId_throwException_IfNoWorkersFound()
            throws WorkerDetailsException {
    ...
    public void updateWorker_throwException_IfNewUsernameExists()
